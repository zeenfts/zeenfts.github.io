...
<div class="fixed bottom-4 right-4 z-40">
  <button
    ...
    class="
    winter:bg-autumn-accent winter:hover:bg-autumn-dark
    spring:bg-summer-accent spring:hover:bg-summer-dark 
    summer:bg-spring-accent summer:hover:bg-spring-dark
    autumn:bg-winter-accent autumn:hover:bg-winter-dark
