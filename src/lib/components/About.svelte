...
<section id="about" class="section-padding bg-gray-50 dark:bg-gray-800">
  <div class="max-width-container px-7 py-9">
    <h2 class="text-3xl font-bold text-center pb-7">
      {$_("about.title") || "About"}
    </h2>
    <div class="grid md:grid-cols-2 gap-12 items-center">
        ...
        <div class="space-y-4">
          <div>
            ...
            <div class="flex flex-wrap gap-2">
              {#each ["Svelte", "React", "Vue", "TailwindCSS"] as skill}
                <span
                  class="px-3 py-1 bg-spring-secondary dark:bg-spring-dark rounded-full text-sm"
                >
                  {skill}
                </span>
              {/each}
          ...
          <div>
            ...
            <div class="flex flex-wrap gap-2">
              {#each ["Node.js", "Hapi", "Python", "PostgreSQL"] as skill}
                <span
                  class="px-3 py-1 bg-summer-secondary dark:bg-summer-dark rounded-full text-sm"
                >
                  {skill}
                </span>
              {/each}
          ...
          <div>
            ...
            <ul class="list-disc pl-5 space-y-1">
              {#each ["Data Specialist 2021-Present", "Data Engineer 2023-2024", "Data Advisor 2020-2021", "Practicum Assistant 2020-2021"] as exprsnce}
                <li>{exprsnce}</li>
              {/each}
            </ul>
          </div>
      ...
      <div class="relative">
        <div
          class="aspect-square bg-gradient-to-br
