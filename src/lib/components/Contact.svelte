...
<section id="contact" class="section-padding py-7 px-7">
  <div class="max-width-container">
    ...
    <div class="max-w-2xl mx-auto">
      <form
        action="https://formspree.io/f/mdkzvykg"
        method="POST"
      ...
      >
        ...
        <input type="hidden" name="_replyto" bind:value={formData.email} />
        <input type="hidden" name="_subject" value="Hi, May I connect with you? |_IMDFGM Web_|" />
      </form>
    </div>
  </div>
</section>